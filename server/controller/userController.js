...
const connection = require('../configBD/configBD');
...
const controller = {
    ...
    registerBD: function(req, res) {
      const{identificacion, nombre, apellidos, email, direccion, telefono, fechaNacimiento, deptoResidencia, municipioResidencia, password, fecha_creacion} = JSON.parse(JSON.stringify(req.body))

      try{
        const sql = "INSERT INTO sql10715861.new_table (idUsuario, nombre, apellido, email, direccion, telefono, fechaNacimiento, deptoResidencia, municipioResidencia, password, fecha_creacion) VALUES (?,?,?,?,?,?,?,?,?,?,?) " 
        console.log(sql)
        connection.execute(sql, {identificacion, nombre, apellidos, email, direccion, telefono, fechaNacimiento, deptoResidencia, municipioResidencia, password, fecha_creacion})
